...
var EditorMapComponent = /** @class */ (function () {
    function EditorMapComponent() {
    }
    EditorMapComponent.prototype.render = function () {
        return "<div class=\"editor-modal-box\">\n        <div class=\"input-header-block\">\n            <input type=\"text\" name=\"coordinate\" placeholder=\"\u7ECF\u5EA6,\u7EAC\u5EA6\">\n            <label for=\"\">\u5750\u6807</label>\n        </div>\n        <div class=\"input-header-block\">\n            <input type=\"text\" name=\"mark\">\n            <label for=\"\">\u6807\u6CE8</label>\n        </div>\n        <div class=\"modal-action\">\n            <div class=\"btn btn-outline-primary\">\u63D2\u5165</div>\n        </div>\n    </div>";
    };
    EditorMapComponent.prototype.bindEvent = function () {
        var _this = this;
        EditorHelper.modalInputBind(this.element, function (data) {
            if (_this.confirmFn) {
                _this.confirmFn({
    ...
    EditorMapComponent.prototype.modalReady = function (module, parent, option) {
        if (!this.element) {
            this.element = $(this.render());
        }
        parent.append(this.element);
...
var EditorApp = /** @class */ (function () {
    ...
    */
    ...
    EditorApp.prototype.renderToolIcon = function (item, target) {
        var iconBody = this.option.toolbarIconMode ? "<i class=\"fa ".concat(item.icon, "\"></i>") : "<span>".concat(item.short ? item.short : item.label, "</span>");
        if (target) {
...
var EditorOptionManager = /** @class */ (function () {
    ...
    Object.defineProperty(EditorOptionManager.prototype, "toolbarIconMode", {
        get: function () {
            var _a;
            return ((_a = this.option.toolbar) === null || _a === void 0 ? void 0 : _a.mode) !== 'label';
        },
        enumerable: false,
        configurable: true
    });
    ...
    EditorOptionManager.prototype.merge = function (option) {
        ...
        if (option.toolbar) {
            var toolbar_1 = this.option.toolbar;
            this.option.toolbar = {
                mode: (_a = option.toolbar.mode) !== null && _a !== void 0 ? _a : toolbar_1 === null || toolbar_1 === void 0 ? void 0 : toolbar_1.mode,
                left: option.toolbar.left ? this.strToArr(option.toolbar.left) : toolbar_1 === null || toolbar_1 === void 0 ? void 0 : toolbar_1.left,
                right: option.toolbar.left ? this.strToArr(option.toolbar.right) : toolbar_1 === null || toolbar_1 === void 0 ? void 0 : toolbar_1.right
            };
        }
    };
    EditorOptionManager.prototype.trans = function (text) {
...
var DivElement = /** @class */ (function () {
    ...
    DivElement.prototype.eachTopRange = function (range, cb) {
        ...
        var _loop_3 = function () {
            ...
            this_3.eachParentNode(next, function (n) {
    ...
    DivElement.prototype.copySelectedNode = function (range) {
        ...
        var _loop_5 = function (i) {
            ...
            var endNode = end >= 0 ? endParentItems[end] : undefined;
            if (beginNode) {
                this_5.eachNextBrother(beginNode, function (n) {
            ...
            if (endNode && (!beginNode || endNode.parentNode !== beginNode.parentNode)) {
                this_5.eachBrother(endNode, function (n) {
