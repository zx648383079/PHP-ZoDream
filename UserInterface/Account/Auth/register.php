...
<div class="login">
    ...
    <form method="POST">
        ...
        <a href="javascript:0;" data-toggle="modal" data-target="#service">服务条款</a>"和"<a href="javascript:0;" data-toggle="modal" data-target="#rule">隐私权相关政策</a>"
    ...
    <div class="modal fade" id="rule" tabindex="-1" role="dialog" aria-labelledby="ruleLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="ruleLabel">隐私权相关政策</h4>
                </div>
                <div class="modal-body">
                    主人公v呵呵
                </div>
