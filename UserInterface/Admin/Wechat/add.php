          ...
          <div class="panel-body">
                <form method="POST" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="original_id" id="input_original_id" class="form-control" value="" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="account" id="input_account" class="form-control" value="" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="token" id="input_token" class="form-control" value="" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="aes_key" id="input_aes_key" class="form-control" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="app_id" id="input_app_id" class="form-control" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="app_secret" id="input_app_secret" class="form-control" value="">
                        </div>
                    </div>
