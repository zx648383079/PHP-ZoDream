    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><b>ZD</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>ZoDream</b></span>
            </a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?=Url::to(['home/main'])?>"><i class="fa fa-circle-o"></i>首页</a></li>
                            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                        </ul>
                    </li>
                    <li class="active treeview">
                        <a href="#">
                            <i class="fa fa-gear"></i> <span>系统功能</span>
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?=Url::to(['system'])?>">
                                    <i class="fa fa-gear"></i>系统配置</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2016-2020 <a href="http://zodream.cn">ZoDream</a>.</strong> All rights
            reserved.
        </footer>
