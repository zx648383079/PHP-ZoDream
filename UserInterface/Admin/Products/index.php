                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($page->getPage() as $value) {?>
                            ...
                            <td>
                                <a href="<?php $this->url('products/view/id/'.$value['id']);?>">查看</a>
                                <a href="<?php $this->url('products/edit/id/'.$value['id']);?>">编辑</a>
                                <a href="<?php $this->url('products/delete/id/'.$value['id']);?>">删除</a>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
