...
var VisualEditor = /** @class */ (function () {
    ...
    VisualEditor.prototype.viewInit = function () {
        ...
        this.toolBar = this.find('.panel-tool-bar');
...
var EditorWeightPanel = /** @class */ (function () {
    ...
    EditorWeightPanel.prototype.renderWeight = function (data) {
        var html = EditorHtmlHelper.mapJoinHtml(data, function (items, key) {
            var text = EditorHtmlHelper.mapJoinHtml(items, function (item) {
...
var EditorBrowser = /** @class */ (function () {
    ...
    */
    ...
    EditorBrowser.prototype.resize = function (left, top, width, height) {
...
var EditorWeight = /** @class */ (function () {
    ...
    EditorWeight.prototype.appendTo = function (parent) {
        var _this = this;
        var pos = parent.children.length;
