    ...
    public function renderForm(SiteWeightModel $model): array {
        ...
        return [
            ...
            VisualInput::select('search_type', '搜索类型', [
                VisualInput::selectOption('网址', 0),
                VisualInput::selectOption('触发部件', 1),
                VisualInput::selectOption('页面内搜索', 2),
