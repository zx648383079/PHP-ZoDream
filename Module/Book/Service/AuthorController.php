...
class AuthorController extends Controller {
    ...
    public function indexAction($id) {
        ...
        $hot_book = BookModel::ofClassify()->where('author_id',  $id)->orderBy('click_count', 'desc')->limit(15)->all();
        $book_list = BookModel::ofClassify()->where('author_id',  $id)->all();
        $month_click = BookModel::ofClassify()->where('author_id',  $id)->orderBy('click_count', 'desc')->limit(5)->all();
