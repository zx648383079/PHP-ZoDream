...
class CategoryController extends Controller {
    ...
    public function indexAction($id) {
        ...
        $new_book = BookModel::ofClassify()->where('cat_id', $id)->order('created_at', 'desc')->limit(4)->all();
        ...
        $size_bang = BookModel::ofClassify()->where('cat_id', $id)->order('size', 'desc')->limit(10)->all();
