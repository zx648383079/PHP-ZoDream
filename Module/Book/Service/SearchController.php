...
class SearchController extends Controller {
    ...
    public function topAction() {
        $click_bang = BookModel::ofClassify()->order('click_count', 'desc')->limit(10)->all();
        $month_click_bang = BookModel::ofClassify()->order('click_count', 'desc')->limit(10)->all();
        $week_click_bang = BookModel::ofClassify()->order('click_count', 'desc')->limit(10)->all();
        $recommend_bang = BookModel::ofClassify()->order('click_count', 'desc')->limit(10)->all();
        $month_recommend_bang = BookModel::ofClassify()->order('click_count', 'desc')->limit(10)->all();
        $week_recommend_bang = BookModel::ofClassify()->order('click_count', 'desc')->limit(10)->all();
