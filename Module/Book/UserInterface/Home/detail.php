...
<!--header结束-->
<div class="clear"></div>
<div class="Layout local">当前位置：<a href="<?=$this->url('book')?>" title="">新书在线-世间唯有读书高</a> >
...
<div class="Layout no_bg no_bor">
  <div class="Con box_con">
    ...
    <div class="info"><a href="<?=$book->url?>" title="<?=$book->name?>"><?=$book->name?></a>
        &#160;|&#160;作者:<?=$book->author?>&#160;|&#160;更新时间：<?=$chapter->created_at?></div>
    ...
    <div class="btn_box">
      ...
      <div class="d"> <a href="<?=$this->url('book')?>" title="返回首页">返回首页</a>&#160;&#166;&#160;<a href="<?=$book->url?>" title="返回目录">返回目录</a>&#160;&#166;&#160;
