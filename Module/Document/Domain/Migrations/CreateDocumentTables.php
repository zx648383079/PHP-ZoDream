...
class CreateDocumentTables extends Migration {
    ...
    public function up() {
        ...
        Schema::createTable(ApiModel::tableName(), function(Table $table) {
            ...
            $table->set('method')->varchar(10)->notNull()->comment('请求方式');
            $table->set('uri')->varchar()->notNull()->comment('接口地址');
        ...
        Schema::createTable(FieldModel::tableName(), function(Table $table) {
            ...
            $table->set('method')->tinyint(3)->defaultVal(1)->comment('参数类型，1:请求字段 2:响应字段 3:header字段');
