function insertHtmlAtCaret(html: string) {
    let sel: Selection, range: Range, editor = $('.dialog-chat-room .dialog-message-text');
    if (!editor.is(":focus")) {
        editor.focus();
...
$(function() {
    let mainBox = $('.dialog-chat-box'),
        addBox = $('.dialog-add-box'),
        userBox = $('.dialog-user-box'),
        searchBox = $('.dialog-search-box'),
        chatBox = $('.dialog-chat-room');
