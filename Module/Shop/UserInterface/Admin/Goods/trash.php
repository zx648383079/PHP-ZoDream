...
<div class="panel-container">
    <div class="page-search-bar">
        ...
        <div class="btn-group pull-right">
            <a class="btn btn-danger" data-type="del" data-tip="确认全部删除？" href="<?=$this->url('./@admin/goods/clear')?>">全部清空</a>
            <a class="btn btn-success" data-type="del" data-tip="确认全部还原？" href="<?=$this->url('./@admin/goods/restore')?>">全部还原</a>
        </div>
    </div>
    ...
    <table class="table table-hover">
        ...
        <?php foreach($model_list as $item):?>
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a class="btn btn-default" data-type="del" data-tip="确认还原此商品？" href="<?=$this->url('./@admin/goods/restore', ['id' => $item->id])?>">还原</a>
