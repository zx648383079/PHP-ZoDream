    ...
    <table class="table table-hover">
        ...
        <?php foreach($model_list as $item):?>
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a class="btn btn-default" href="<?=$this->url('./@admin/activity/free_trial/apply', ['id' => $item->id])?>">申请记录</a>
                        <a class="btn btn-default" href="<?=$this->url('./@admin/activity/free_trial/report', ['id' => $item->id])?>">试用报告</a>
                        <a class="btn btn-default" href="<?=$this->url('./@admin/activity/free_trial/edit', ['id' => $item->id])?>">编辑</a>
